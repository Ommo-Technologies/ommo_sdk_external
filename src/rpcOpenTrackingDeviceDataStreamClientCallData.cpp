...
rpcOpenTrackingDeviceDataStreamClientCallData::rpcOpenTrackingDeviceDataStreamClientCallData(
    ...
    cb_handler_(cb_handler) 
{
    ...
    reader_ = stub->PrepareAsyncOpenTrackingDeviceDataStream(&grpc_client_context, request, completion_queue);
...
bool rpcOpenTrackingDeviceDataStreamClientCallData::Proceed(OperationType op_type)
{
